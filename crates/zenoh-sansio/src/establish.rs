...
use zenoh_proto::{fields::*, zerror::HandshakeError};
...
pub fn negotiate_resolution(
...
) -> core::result::Result<Resolution, HandshakeError> {
    ...
    if i_fsn_res > m_fsn_res {
        return Err(HandshakeError::InvalidPeerResolution);
    }
...
pub fn negotiate_batch_size(mine_batch_size: u16, other_batch_size: u16) -> u16 {
    core::cmp::min(mine_batch_size, other_batch_size)
}
